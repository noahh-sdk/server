...
#[post("/v1/mods/{id}")]
async fn publish_mod(id: String, data: web::Data<AppData>, mut noahh_file: web::Payload) -> Result<impl Responder, Error> {
    // todo: authenticate
...
async fn main() -> anyhow::Result<()> {
    ...
    let pool = sqlx::SqlitePool::connect("../db/noahh-index.db").await?;
