...
impl ModVersionGetOne {
    pub fn into_mod_version(&self) -> ModVersion {
        ModVersion {
            ...
            noahh_version: self.noahh_version.clone(),
...
impl ModVersion {
    ...
    pub async fn create_from_json(json: &ModJson, pool: &mut PgConnection) -> Result<(), ApiError> {
        ...
        builder.push("name, version, download_link, hash, noahh_version, windows, android32, android64, mac, ios, early_load, api, mod_id) VALUES (");
